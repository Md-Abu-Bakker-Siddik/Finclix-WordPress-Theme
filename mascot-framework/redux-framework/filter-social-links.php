<?php
	...
	$enabled_social_links = apply_filters( 'finclix_redux_config_social_links_enabled', $enabled_social_links );
	...
	$backup_social_links = apply_filters( 'finclix_redux_config_social_links_backup', $backup_social_links );
	...
	$redux_config_social_links_arraylist_1 = array(
		array(
			...
			'type'     => 'sorter',
			'title'    => esc_html__( 'Social Links Ordering', 'finclix' ),
			'desc'     => '',
			'compiler' => 'true',
			'options'	=> array(
		...
		array(
			...
			'type'     => 'select',
			'title'    => esc_html__( 'Open links in', 'finclix' ),
			'subtitle' => '',
			'desc'     => '',
			'options'	=> array(
		...
		array(
			...
			'type'     => 'section',
			'title'    => esc_html__( 'Social URLs', 'finclix' ),
			'subtitle' => '',
