	...
	<?php
	/**
	* finclix_before_footer hook.
	*
	*/
	do_action( 'finclix_before_footer' );
	?>
	<footer id="footer" class="footer <?php echo esc_attr( $footer_classes );?>">
	<?php
		/**
		* finclix_footer_start hook.
		*
		*/
		do_action( 'finclix_footer_start' );
	?>
		<div class="footer-widget-area">
			<?php if ( isset($footer_widget_area) && !empty($footer_widget_area) && mascot_core_finclix_plugin_installed() ) { ?>
	...
	<?php
		/**
		* finclix_footer_end hook.
		*
		*/
		do_action( 'finclix_footer_end' );
	?>
	</footer>
	<?php
	/**
	* finclix_after_footer hook.
	*
	*/
	do_action( 'finclix_after_footer' );
	?>