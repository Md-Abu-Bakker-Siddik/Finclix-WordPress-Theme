	...
	<div class="author-info">
		...
		<div class="author-description">
			<h4 class="author-title">
				<span class="author-title-label"><?php esc_html_e('About Author:', 'finclix' ); ?></span>
			...
			<ul class="styled-icons square-sm author-social m-0">
				...
				<li><a class="styled-icons-item" target="_blank" href="<?php echo esc_url( $each_icon['url'] );?>"><i class="<?php echo esc_attr( $each_icon['class'] );?>"></i></a></li>
				<?php endforeach; ?>
			</ul>
			<?php endif; ?>
			<?php endif; ?>
