	...
	<div class="related-posts">
		...
		<h4 class="title"><?php esc_html_e('Related Posts', 'finclix' ); ?></h4>
		...
		<?php
			...
			?>
			<div class="item">
				<?php finclix_get_blocks_template_part( 'post-related-posts-common', null, 'blog-single/tpl/parts', $params ); ?>
			</div>
			<?php
			endwhile;
		?>
