<div class="helpful-links">
	...
	if ( has_nav_menu( $helpful_links_nav ) ) {
		...
		echo '<p>' . sprintf( esc_html__( 'Please Create a Menu from %1$shere%2$s and set it\'s Display Location to %3$sPage 404 Helpful Links%4$s', 'finclix' ), '<a target="_blank" href="' . esc_url( admin_url('nav-menus.php') ) . '">', '</a>', '<strong>', '</strong>') . '</p>';
	}
	?>
</div>