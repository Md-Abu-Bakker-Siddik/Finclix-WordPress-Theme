						...
						<div class="col">
							...
							<div class="row header-nav-col-row">
								...
								<div class="col-sm-auto pl--0 align-self-center pe-xl-4 menuzord-side-icon-list">
									...
									<?php
										/**
										* finclix_header_nav_side_icons hook.
										*
										* @hooked finclix_get_header_search_icon - 10
										* @hooked finclix_get_header_mini_cart_icon - 15
										* @hooked finclix_get_header_side_push_panel_sidebar - 20
										* @hooked finclix_get_header_nav_custom_button - 25
										*/
										do_action( 'finclix_header_nav_side_icons' );
									?>
									</div>
								</div>
							</div>
