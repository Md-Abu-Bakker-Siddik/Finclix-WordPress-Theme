 ...
 */
require_once FINCLIX_FRAMEWORK_DIR . '/tgm/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'finclix_register_required_plugins' );
 ...
 */
function finclix_register_required_plugins() {
	$plugins_path = FINCLIX_FRAMEWORK_DIR . '/tgm/plugins';
	...
	$plugins = array(
		array(
			'name'         	=> 'Mascot Core - Finclix',
			'slug'         	=> 'mascot-core-finclix',
			'source'       	=> $server_path . 'mascot-core-elementor/mascot-core-finclix.zip',
			'required'     	=> true,
			'version'      	=> '1.0'
		),
		array(
	 ...
	 */
	$config = array(
		'id'           => 'finclix',                 // Unique ID for hashing notices for multiple instances of TGMPA.
		...
		'message'      => '<div class="notice notice-info is-dismissible mt-20">
			...
			<p><strong>Note from Author ' . FINCLIX_AUTHOR . ':</strong> To ensure the latest version of <em>theme required</em> plugins, you must have the latest version of <strong>' . $theme_name . '</strong></p>
